...
--DROP DATABASE QL_QUAN_TRA_SUA							Của nhóm
--GO 
-----------------------------------------------------------------------------
...
------------------------------------------------------------------------------
	...
	insert into NHANVIEN values ('NV001',N' Nguyễn Văn A','Nam', '04255352562','nv1.jpg',N' Quản lý',N'Thành phố Hồ Chí Minh',1),
								('NV002',N' Nguyễn Cát Tường',N'Nữ','0352576389','nv2.jpg',N' Nhân viên',N'Bến Tre',1),
								('NV003',N' Bình Tiểu Lĩnh',N'Nữ','0375849219','nv3.jpg',N' Nhân viên',N'Bình Thuận',1),
								('NV004',N' Nguyễn An Vinh','Nam','0743939858','nv4.jpg',N' Nhân  viên',N'Đăk Lăk',1)
	...
	insert into KHACHHANG values ('KH001',N' Nguyễn Thị B','0587692446',1),
								 ('KH002',N' Huỳnh Văn C','06948556872',1),
								 ('KH003',N' Trần Chí C','0385922016',1),
								 ('KH004',N' Đặng Thanh D','069298776',1),
								 ('KH005',N' Đinh Thành H','0847285998',1)
